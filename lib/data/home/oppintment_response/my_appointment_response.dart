...
class MyAppointmentResponse {
  ...
  MyAppointmentResponse.fromJson(dynamic json) {
...
/// appointment_time : "Monday, November 10, 2025 2:00 PM"
/// appointment_end_time : "Monday, November 10, 2025 2:30 PM"
/// status : "pending"
/// notes : ""
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    id = json['id'];
    doctor = json['doctor'] != null ? MyAppointmentDoctor.fromJson(json['doctor']) : null;
...
class MyAppointmentDoctor {
  ...
  MyAppointmentDoctor.fromJson(dynamic json) {
    id = json['id'];
    name = json['name'];
    email = json['email'];
    phone = json['phone'];
