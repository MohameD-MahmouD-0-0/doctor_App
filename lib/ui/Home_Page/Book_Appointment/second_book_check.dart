      ...
      children: [
        ...
        RadioListTile(
            ...
            value: 1, groupValue:  widget.currentValue, onChanged: (value){
              setState(() {
                ...
                Provider.of<ChoseDoctorMeet>(context,listen: false).selectPayWay('Credit Card');
        ...
        RadioListTile(
            ...
            value: 2, groupValue:  widget.currentValue, onChanged: (value){
              setState(() {
                widget.currentValue = value!;
                Provider.of<ChoseDoctorMeet>(context,listen: false).selectPayWay('Bank Transfer');
        ...
        RadioListTile(
            ...
            value: 3, groupValue: widget.currentValue, onChanged: (value){
              setState(() {
                Provider.of<ChoseDoctorMeet>(context,listen: false).selectPayWay('Paypal');
                widget.currentValue = value!;
              });
        })
      ],
